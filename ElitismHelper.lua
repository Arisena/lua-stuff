...
local Spells = {
	...
	--Uldir
	[272582] = 20,		--- Sanguine Static (Taloc)
        [274921] = 20,          --- Uldir Defense Beam (Taloc)
	[267787] = 20,		--- Sanitizing Strike (M.O.T.H.E.R)
	[268253] = 20,		--- Uldir Defense Beams (M.O.T.H.E.R)
        [267795] = 10,          --- Purifying Flame (M.O.T.H.E.R)
	[262291] = 10,		--- Rotting Regurgitation (Fetid Devourer)
	[265530] = 20,		--- Surging Darkness (Zek'voz)
	[273554] = 20,		--- Obliteration Blast (Mythrax)
...
local SpellsNoTank = {
	...
	--Uldir
	[271296] = 20,		--- Cudgel of Gore (Taloc)
	[265261] = 20,		--- Void Lash (Zek'voz)
  	[274358] = 10,    	--- Rupturing Blood (Zul)
  	[273316] = 20,    	--- Bloody Cleave (Zul)
